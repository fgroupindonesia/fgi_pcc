...
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
$route['admin/close'] = 'Admin/closedAccess';
...
$route['remote/update/account'] = 'Remote/updateMe';
$route['remote/send/command'] = 'Remote/sendCommand';
$route['client/update/command'] = 'Client/updateCommand';
$route['client/update/tracker'] = 'Client/updateTracker';